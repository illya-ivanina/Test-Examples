...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        testWithConsuming(appProperties);

    }

    static void testWithConsuming(Properties properties) throws IOException {
        var kafkaConsumerTestDemo = new KafkaConsumerTestDemo(properties);
        kafkaConsumerTestDemo.consume(properties.getProperty("topic_name"));
    }
